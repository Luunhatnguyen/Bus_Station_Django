# Generated by Django 4.0.3 on 2023-04-16 08:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberplate', models.CharField(default=0, max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point', models.CharField(default='0', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_code', models.CharField(choices=[('APPROVE', 'Approve'), ('NOT APPROVE', 'Notapprove'), ('PENDING', 'Pending')], default='PENDING', max_length=12)),
                ('garageID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='carrier_garage', related_query_name='this_carrier_garage', to='ticketapp.garage')),
                ('optionID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='carrier', related_query_name='this_carrier_optionID', to='ticketapp.hireoption')),
                ('userID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='carrier', related_query_name='this_carrier_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='bus',
            name='carrierID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticketapp.carrier'),
        ),
        migrations.AddField(
            model_name='bus',
            name='garageID',
